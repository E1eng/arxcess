...
impl ProductState {
    ...
    pub const ARCIUM_MXE_CIPHERTEXTS_OFFSET: u32 = Self::ARCIUM_MXE_MATERIAL_OFFSET + 16;
    pub const ARCIUM_MXE_CIPHERTEXTS_LEN: u32 = (32 * ARCIUM_CUSTODY_CIPHERTEXT_COUNT) as u32;
